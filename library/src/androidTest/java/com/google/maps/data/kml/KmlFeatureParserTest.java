...
public class KmlFeatureParserTest extends ActivityTestCase {
    ...
    public void testPolygon() throws Exception {
        XmlPullParser xmlPullParser = createParser(com.google.maps.android.test.R.raw.amu_basic_placemark);
    ...
    public void testMultiGeometry() throws Exception {
        XmlPullParser xmlPullParser = createParser(com.google.maps.android.test.R.raw.amu_multigeometry_placemarks);
        KmlPlacemark placemark = KmlFeatureParser.createPlacemark(xmlPullParser);
        assertNotNull( placemark );
    ...
    public void testExtendedData() throws Exception {
        XmlPullParser xmlPullParser = createParser(com.google.maps.android.test.R.raw.amu_multiple_placemarks);
        KmlPlacemark placemark = KmlFeatureParser.createPlacemark(xmlPullParser);
    ...
    public void testGroundOverlay() throws Exception {
        ...
        xmlPullParser = createParser(com.google.maps.android.test.R.raw.amu_ground_overlay_color);
        groundOverlay = KmlFeatureParser.createGroundOverlay(xmlPullParser);
        assertNotNull(groundOverlay);
    }

    public void testMultiGeometries() throws Exception {
        XmlPullParser xmlPullParser = createParser(com.google.maps.android.test.R.raw.amu_nested_multigeometry);
